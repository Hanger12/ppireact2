                ...
                <div>
                    ...
                    <ul className="pageList">
                        {items.length!==0 ? items.map(item => (
                                <li key={item.id}>
                                    <p id="newsTitle" className={document.getElementById('react-switch-new').checked===false?"newsTitle":"newsTitleDark"}><Link className={document.getElementById('react-switch-new').checked===false?"newTitleLink":"newTitleLinkDark"} id="headerNews" to={"/news/"+item.id}>{item.title}</Link></p>
        ...
        return (
            <div>
                <ul className="pageList">
                    ...
                    {items.length!==0 ? items.map(item => (
                            <li key={item.id}>
                                <p className={document.getElementById('react-switch-new').checked===false?"newsTitle":"newsTitleDark"} id="newsTitle"><Link className={document.getElementById('react-switch-new').checked===false?"newTitleLink":"newTitleLinkDark"} id="headerNews" to={"/news/"+item.id}>{item.title}</Link></p>
